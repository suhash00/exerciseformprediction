...
Now let us set up the train control object with the method as cross-validation. Also 5 folds seems to be a good number of folds to strike a balance between not having too many or too few folds.
...
Let us see how the trained model performs by comparing its predictions with for the test set that we held out.
...
For the sake of brevity in the final report, the output of some of the commands in this section have been suppressed.
